    ...
    .ele('body-definition')
      .ele('personal')
        .ele('name', measurement.person.name)
          .up()
        .ele('date-of-birth', measurement.person.dob)
          .up()
      ...
      .ele('measurements')
        ...
        .up()
      .ele('colors')
        .ele('eye-color',measurement.eye_color)
          .up()
        .ele('hair-color', measurement.hair_color)
          .up()
        .ele('skin-complexion', measurement.skin_complexion)
          .up()
        .up()
      .ele('bio-data')
        .ele('blood-type',measurement.blood_type)
          .up()
        .ele('allergy', measurement.allergy)
          .up()
        .ele('eye_performance', measurement.eye_performance)
          .up()
        .up()
